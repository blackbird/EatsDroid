 ...
 */
public class CustomValuesGenerator extends BaseValuesGenerator {

    public CustomValuesGenerator(Parameters parameters) {
        super(parameters);
    }
